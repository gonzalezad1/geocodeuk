...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { lat: @office.lat, lat: @office.lat, long: @office.long, long: @office.long, name: @office.name, postcode: @office.postcode } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { lat: @office.lat, lat: @office.lat, long: @office.long, long: @office.long, name: @office.name, postcode: @office.postcode } }
